...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function co(e,t,n){let r=new Float32Array(Ya),i=new W(0,1,0);return new Hi({name:`SphericalGaussianBlur`,defines:{n:Ya,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:fo(),fragmentShader:`
	...
	`}var po=class extends mn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,nl=8;function rl(e){let t=e.trim();t.startsWith(`#`)&&(t=t.slice(1));let n=255,r=255,i=255;return t.length===3?(n=parseInt(t[0]+t[0],16),r=parseInt(t[1]+t[1],16),i=parseInt(t[2]+t[2],16)):t.length===6&&(n=parseInt(t.slice(0,2),16),r=parseInt(t.slice(2,4),16),i=parseInt(t.slice(4,6),16)),new W(n/255,r/255,i/255)}function il({linesGradient:e,enabledWaves:t=[`top`,`middle`,`bottom`],lineCount:n=[6],lineDistance:r=[5],topWavePosition:i,middleWavePosition:a,bottomWavePosition:o={x:2,y:-.7,rotate:-1},animationSpeed:s=1,interactive:c=!0,bendRadius:l=5,bendStrength:u=-.5,mouseDamping:d=.05,parallax:f=!0,parallaxStrength:p=.2,mixBlendMode:m=`screen`,className:h}){let g=(0,_.useRef)(null),v=(0,_.useRef)(new U(-1e3,-1e3)),y=(0,_.useRef)(new U(-1e3,-1e3)),b=(0,_.useRef)(0),x=(0,_.useRef)(0),S=(0,_.useRef)(new U(0,0)),C=(0,_.useRef)(new U(0,0)),w=Qc(),T=c&&!w,E=f&&!w,D=e=>typeof n==`number`?n:t.includes(e)?n[t.indexOf(e)]??6:0,O=e=>typeof r==`number`?r:t.includes(e)?r[t.indexOf(e)]??.1:.1,k=t.includes(`top`)?D(`top`):0,A=t.includes(`middle`)?D(`middle`):0,ee=t.includes(`bottom`)?D(`bottom`):0,te=t.includes(`top`)?O(`top`)*.01:.01,ne=t.includes(`middle`)?O(`middle`)*.01:.01,re=t.includes(`bottom`)?O(`bottom`)*.01:.01;return(0,_.useEffect)(()=>{let n=g.current;if(!n)return;let r=!0,c=new er,f=new ga(-1,1,1,-1,0,1);f.position.z=1;let m=new Zc({antialias:!0,alpha:!0}),h=w?1.25:2;m.setPixelRatio(Math.min(window.devicePixelRatio||1,h)),m.domElement.style.width=`100%`,m.domElement.style.height=`100%`,n.appendChild(m.domElement);let _={iTime:{value:0},iResolution:{value:new W(1,1,1)},animationSpeed:{value:s},enableTop:{value:t.includes(`top`)},enableMiddle:{value:t.includes(`middle`)},enableBottom:{value:t.includes(`bottom`)},topLineCount:{value:k},middleLineCount:{value:A},bottomLineCount:{value:ee},topLineDistance:{value:te},middleLineDistance:{value:ne},bottomLineDistance:{value:re},topWavePosition:{value:new W(i?.x??10,i?.y??.5,i?.rotate??-.4)},middleWavePosition:{value:new W(a?.x??5,a?.y??0,a?.rotate??.2)},bottomWavePosition:{value:new W(o?.x??2,o?.y??-.7,o?.rotate??.4)},iMouse:{value:new U(-1e3,-1e3)},interactive:{value:T},bendRadius:{value:l},bendStrength:{value:u},bendInfluence:{value:0},parallax:{value:E},parallaxStrength:{value:p},parallaxOffset:{value:new U(0,0)},lineGradient:{value:Array.from({length:nl},()=>new W(1,1,1))},lineGradientCount:{value:0}};if(e&&e.length>0){let t=e.slice(0,nl);_.lineGradientCount.value=t.length,t.forEach((e,t)=>{let n=rl(e);_.lineGradient.value[t].set(n.x,n.y,n.z)})}let D=new Hi({uniforms:_,vertexShader:el,fragmentShader:tl,transparent:!0,depthWrite:!1}),O=new Ni(2,2),ie=new _i(O,D);c.add(ie);let j=new Na,M=()=>{if(!r)return;let e=n.clientWidth||1,t=n.clientHeight||1;m.setSize(e,t,!1);let i=m.domElement.width,a=m.domElement.height;_.iResolution.value.set(i,a,1)};M();let ae=typeof ResizeObserver<`u`?new ResizeObserver(()=>{r&&M()}):null;ae&&ae.observe(n);let oe=e=>{let t=m.domElement.getBoundingClientRect(),n=e.clientX-t.left,r=e.clientY-t.top,i=m.getPixelRatio();if(v.current.set(n*i,(t.height-r)*i),b.current=1,E){let e=t.width/2,i=t.height/2,a=(n-e)/t.width,o=-(r-i)/t.height;S.current.set(a*p,o*p)}},N=()=>{b.current=0};T&&(m.domElement.addEventListener(`pointermove`,oe),m.domElement.addEventListener(`pointerleave`,N));let se=0,P=()=>{r&&(_.iTime.value=j.getElapsedTime(),T&&(y.current.lerp(v.current,d),_.iMouse.value.copy(y.current),x.current+=(b.current-x.current)*d,_.bendInfluence.value=x.current),E&&(C.current.lerp(S.current,d),_.parallaxOffset.value.copy(C.current)),m.render(c,f),se=requestAnimationFrame(P))};return P(),()=>{r=!1,cancelAnimationFrame(se),ae&&ae.disconnect(),T&&(m.domElement.removeEventListener(`pointermove`,oe),m.domElement.removeEventListener(`pointerleave`,N)),O.dispose(),D.dispose(),m.dispose(),m.forceContextLoss(),m.domElement.parentElement&&m.domElement.parentElement.removeChild(m.domElement)}},[e,t,n,r,i,a,o,s,T,l,u,d,E,p,w]),(0,Z.jsx)(`div`,{ref:g,className:`floating-lines-container ${h||``}`,style:{mixBlendMode:m},"aria-hidden":`true`})}var al={blue:`linear-gradient(hsl(223, 90%, 50%), hsl(208, 90%, 50%))`,purple:`linear-gradient(hsl(283, 90%, 50%), hsl(268, 90%, 50%))`,red:`linear-gradient(hsl(3, 90%, 50%), hsl(348, 90%, 50%))`,indigo:`linear-gradient(hsl(253, 90%, 50%), hsl(238, 90%, 50%))`,orange:`linear-gradient(hsl(43, 90%, 50%), hsl(28, 90%, 50%))`,green:`linear-gradient(hsl(123, 90%, 40%), hsl(108, 90%, 40%))`};function ol({items:e,className:t,colorful:n=!1}){let r=e=>n?al[e]?{background:al[e]}:{background:e}:{background:`linear-gradient(hsl(263, 90%, 55%), hsl(238, 90%, 55%))`};return(0,Z.jsx)(`div`,{className:`rb-icon-btns ${t||``}`,children:e.map((e,t)=>(0,Z.jsxs)(`button`,{className:`rb-icon-btn ${e.customClass||``}`,"aria-label":e.label,type:`button`,children:[(0,Z.jsx)(`span`,{className:`rb-icon-btn__back`,style:r(e.color)}),(0,Z.jsx)(`span`,{className:`rb-icon-btn__front`,children:(0,Z.jsx)(`span`,{className:`rb-icon-btn__icon`,"aria-hidden":`true`,children:e.icon})}),(0,Z.jsx)(`span`,{className:`rb-icon-btn__label`,children:e.label})]},t))})}var sl=`https://formspree.io/f/xzdyajgz`,cl=[`Регион`,`Идея`,`Цифра`,`Цена`],ll=[{id:`region`,type:`text`,number:`01`,text:`Из какого вы города или района?`,sub:`Название поможет понять географию спроса — можно кратко.`,placeholder:`Например: Самарканд, Наманган, Андижан…`},{id:`idea`,type:`single`,number:`02`,text:`Какая IT-идея, на ваш взгляд, нужнее всего в регионах Узбекистана?`,sub:`Выберите одну — ту, которой реально не хватает у вас дома.`,options:[{emoji:`🔧`,label:`Маркетплейс мастеров и ремонта`,sub:`Найти сантехника, электрика, отделочника`},{emoji:`👷`,label:`HR-платформа для рабочих`,sub:`Заводы, стройки, рестораны ищут сотрудников`},{emoji:`📊`,label:`SaaS-учёт для малого бизнеса`,sub:`Бухгалтерия и касса для ИП и магазинов`},{emoji:`🌾`,label:`Агромаркетплейс для фермеров`,sub:`Продажа урожая напрямую без посредников`},{emoji:`📦`,label:`Логистика и доставка`,sub:`Для интернет-магазинов и e-commerce`},{emoji:`🎓`,label:`EdTech — подготовка к DTM/ЕГЭ`,sub:`Онлайн-репетиторы и курсы`}]},{id:`digital`,type:`single`,number:`03`,text:`Люди 25+ лет у вас дома — насколько уверенно пользуются смартфоном и интернетом?`,sub:`Ориентируйтесь на родителей, соседей, знакомых из вашего города или района.`,options:[{emoji:`💪`,label:`Уверенно — сами всё делают`,sub:`Оплачивают, заказывают такси, переписываются`},{emoji:`🙂`,label:`В основном справляются`,sub:`Иногда просят детей помочь с чем-то новым`},{emoji:`😕`,label:`Только базовое`,sub:`WhatsApp и звонки — больше ничего`},{emoji:`📵`,label:`Почти не пользуются`,sub:`Кнопочный телефон или вообще без смартфона`}]},{id:`price`,type:`single`,number:`04`,text:`Какую сумму в месяц люди у вас готовы платить за удобный сервис?`,sub:`Например, за приложение, где легко найти мастера или работника.`,options:[{emoji:`🆓`,label:`Только бесплатно`,sub:`Платить за приложение не будут вообще`},{emoji:`💵`,label:`10 000 – 20 000 сум (~$0.8–1.5)`,sub:`Небольшая сумма, почти символическая`},{emoji:`💰`,label:`30 000 – 50 000 сум (~$2.5–4)`,sub:`Если сервис реально полезный`},{emoji:`💎`,label:`100 000+ сум (~$8+)`,sub:`За качественный продукт заплатят хорошо`}]}];async function ul(e){let t=typeof sl==`string`&&sl.trim()||``;if(!t)return{ok:!1,skipped:!0};let n=await fetch(t,{method:`POST`,headers:{"Content-Type":`application/json`,Accept:`application/json`},body:JSON.stringify({_subject:`Опрос IT Узбекистан — новый ответ`,...e})});return{ok:n.ok,skipped:!1,status:n.status}}function dl(e){return Math.max(0,Math.min(100,e))}function fl(){let[e,t]=(0,_.useState)(0),[n,r]=(0,_.useState)({region:``,idea:null,digital:null,price:null}),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)({state:`idle`}),c=Math.round((Math.min(e,ll.length-1)+1)/ll.length*100),l=(0,_.useMemo)(()=>[{icon:(0,Z.jsx)(ne,{}),color:`indigo`,label:`Регион`},{icon:(0,Z.jsx)(ie,{}),color:`blue`,label:`Идея`},{icon:(0,Z.jsx)(re,{}),color:`red`,label:`Польза`},{icon:(0,Z.jsx)(M,{}),color:`purple`,label:`Онлайн`},{icon:(0,Z.jsx)(j,{}),color:`orange`,label:`Просто`},{icon:(0,Z.jsx)(ae,{}),color:`green`,label:`Вывод`}],[]),u=ll[e],d=t=>t<e?`done`:t===e?`active`:`todo`,f=n=>{r(e=>({...e,[u.id]:n})),window.setTimeout(()=>{e===ll.length-1?h():t(e=>e+1)},220)},p=()=>{let e=(n.region||``).trim();r(t=>({...t,region:e||`Не указано`})),t(e=>Math.min(e+1,ll.length-1))},m=()=>t(e=>Math.max(0,e-1)),h=async()=>{a(!0),s({state:`sending`});let e=n.idea,t=n.digital,r=n.price,i=ll[1].options?.[e]?.label||`—`,o=ll[2].options?.[t]?.label||`—`,c=ll[3].options?.[r]?.label||`—`,l={region:n.region||`Не указано`,idea:i,idea_index:e,digital:o,digital_index:t,price:c,price_index:r,submitted_at:new Date().toISOString()};try{let e=await ul(l);e.ok?s({state:`ok`}):s({state:`err`,status:e.status})}catch{s({state:`err`})}},g=()=>{r({region:``,idea:null,digital:null,price:null}),t(0),a(!1),s({state:`idle`})},v=(0,_.useMemo)(()=>{let e=ll[1].options?.[n.idea]?.label||`—`,t=ll[2].options?.[n.digital]?.label||`—`,r=ll[3].options?.[n.price]?.label||`—`;return`📍 Регион: ${n.region||`Не указано`}\n💡 Лучшая идея: ${e}\n📱 Уровень цифровой грамотности 25+: ${t}\n💳 Готовность платить: ${r}`},[n]),y=dl([90,65,35,10][n.digital??1]??50),b=dl([5,40,75,100][n.price??1]??50),x=u?.type===`text`?!0:n[u.id]!==null&&n[u.id]!==void 0;return(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(`div`,{className:`bg-webgl`,children:(0,Z.jsx)(il,{enabledWaves:[`top`,`middle`,`bottom`],lineCount:[5,7,5],lineDistance:[8,8,8],bendRadius:8,bendStrength:-2,interactive:!0,parallax:!0,animationSpeed:1,linesGradient:[`#e945f5`,`#a78bfa`,`#6a6a6a`],mixBlendMode:`screen`})}),(0,Z.jsxs)(`div`,{className:`wrap`,children:[(0,Z.jsxs)(`header`,{className:`hero`,role:`banner`,children:[(0,Z.jsxs)(`div`,{className:`badge`,children:[(0,Z.jsx)(`span`,{className:`badge-dot`,"aria-hidden":`true`}),` IT-опрос · Узбекистан`]}),(0,Z.jsx)(`h1`,{children:`Какие IT-идеи реально нужны в вашем регионе?`}),(0,Z.jsxs)(`div`,{className:`hero-meta`,children:[(0,Z.jsx)(`span`,{children:`Анонимно`}),(0,Z.jsx)(`span`,{children:`~3 минуты`}),(0,Z.jsx)(`span`,{children:`С телефона удобно`})]}),(0,Z.jsx)(`div`,{className:`hero-icons`,"aria-hidden":`true`,children:(0,Z.jsx)(ol,{items:l,colorful:!1})})]}),(0,Z.jsx)(`div`,{className:`stepper`,"aria-hidden":`true`,children:ll.map((e,t)=>{let n=d(t);return(0,Z.jsxs)(`div`,{className:`step ${n}`,children:[(0,Z.jsx)(`div`,{className:`step-circle`,children:n===`done`?`✓`:t+1}),(0,Z.jsx)(`span`,{className:`step-label`,children:cl[t]})]},t)})}),(0,Z.jsxs)(`div`,{className:`progress-wrap`,"aria-hidden":`true`,children:[(0,Z.jsxs)(`div`,{className:`progress-meta`,children:[(0,Z.jsx)(`span`,{children:i?`Готово`:`Вопрос ${e+1} из ${ll.length}`}),(0,Z.jsx)(`span`,{children:i?`100%`:`${c}%`})]}),(0,Z.jsx)(`div`,{className:`progress-bar-bg`,children:(0,Z.jsx)(`div`,{className:`progress-bar-fill`,style:{width:`${i?100:c}%`}})})]}),(0,Z.jsxs)(`main`,{role:`main`,children:[i?(0,Z.jsxs)(`div`,{className:`results-card`,children:[o.state===`sending`?(0,Z.jsx)(`div`,{className:`submission-banner warn`,children:`Отправка ответов…`}):o.state===`ok`?(0,Z.jsx)(`div`,{className:`submission-banner ok`,children:`Ответы отправлены. Спасибо!`}):o.state===`err`?(0,Z.jsxs)(`div`,{className:`submission-banner err`,children:[`Не удалось отправить ответы`,o.status?` (код ${o.status})`:``,`. Итог ниже можно скопировать вручную.`]}):null,(0,Z.jsxs)(`div`,{className:`results-header`,children:[(0,Z.jsx)(`div`,{className:`results-icon`,"aria-hidden":`true`,children:`✅`}),(0,Z.jsx)(`h2`,{children:`Спасибо за ответы`}),(0,Z.jsx)(`p`,{children:`Ниже — краткий итог. Полные ответы доступны в кабинете Formspree.`})]}),(0,Z.jsxs)(`div`,{className:`result-row`,children:[(0,Z.jsx)(`div`,{className:`result-label`,children:`📍 Ваш регион`}),(0,Z.jsx)(`div`,{className:`result-value`,children:n.region||`Не указано`})]}),(0,Z.jsx)(`div`,{className:`divider`}),(0,Z.jsxs)(`div`,{className:`result-row`,children:[(0,Z.jsx)(`div`,{className:`result-label`,children:`💡 Самая нужная идея`}),(0,Z.jsxs)(`div`,{className:`result-value`,children:[ll[1].options?.[n.idea]?.emoji,` `,ll[1].options?.[n.idea]?.label]})]}),(0,Z.jsx)(`div`,{className:`divider`}),(0,Z.jsxs)(`div`,{className:`result-row`,children:[(0,Z.jsx)(`div`,{className:`result-label`,children:`📱 Цифровая грамотность 25+`}),(0,Z.jsxs)(`div`,{className:`result-value`,children:[ll[2].options?.[n.digital]?.emoji,` `,ll[2].options?.[n.digital]?.label]}),(0,Z.jsx)(`div`,{className:`result-bar-bg`,children:(0,Z.jsx)(`div`,{className:`result-bar-fill`,style:{width:`${y}%`}})})]}),(0,Z.jsx)(`div`,{className:`divider`}),(0,Z.jsxs)(`div`,{className:`result-row`,children:[(0,Z.jsx)(`div`,{className:`result-label`,children:`💳 Готовность платить`}),(0,Z.jsxs)(`div`,{className:`result-value`,children:[ll[3].options?.[n.price]?.emoji,` `,ll[3].options?.[n.price]?.label]}),(0,Z.jsx)(`div`,{className:`result-bar-bg`,children:(0,Z.jsx)(`div`,{className:`result-bar-fill`,style:{width:`${b}%`}})})]}),(0,Z.jsxs)(`div`,{className:`copy-block`,children:[(0,Z.jsx)(`div`,{className:`copy-label`,children:`Скопируйте итог`}),(0,Z.jsx)(`pre`,{className:`copy-text`,id:`copy-content`,children:v}),(0,Z.jsx)(`button`,{type:`button`,className:`copy-btn`,onClick:async e=>{let t=e.currentTarget;try{await navigator.clipboard.writeText(v),t.textContent=`✅ Скопировано`,window.setTimeout(()=>t.textContent=`📋 Скопировать ответы`,1800)}catch{t.textContent=`Не удалось скопировать`,window.setTimeout(()=>t.textContent=`📋 Скопировать ответы`,1800)}},children:`📋 Скопировать ответы`})]}),(0,Z.jsx)(`button`,{type:`button`,className:`btn btn-ghost full`,onClick:g,children:`Пройти заново`})]}):(0,Z.jsxs)(`div`,{className:`question-card`,children:[(0,Z.jsxs)(`div`,{className:`q-number`,children:[`Вопрос `,u.number]}),(0,Z.jsx)(`h2`,{className:`q-text`,children:u.text}),(0,Z.jsx)(`p`,{className:`q-sub`,children:u.sub}),u.type===`text`?(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(`label`,{className:`sr-only`,htmlFor:`region`,children:u.text}),(0,Z.jsx)(`input`,{id:`region`,className:`region-input`,type:`text`,inputMode:`text`,autoComplete:`address-level2`,placeholder:u.placeholder,value:n.region,onChange:e=>r(t=>({...t,region:e.target.value})),onKeyDown:e=>{e.key===`Enter`&&p()}}),(0,Z.jsxs)(`div`,{className:`nav`,children:[(0,Z.jsx)(`div`,{}),(0,Z.jsx)(`button`,{type:`button`,className:`btn btn-primary`,onClick:p,children:`Далее →`})]})]}):(0,Z.jsxs)(Z.Fragment,{children:[(0,Z.jsx)(`div`,{className:`options`,role:`radiogroup`,"aria-label":u.text,children:u.options.map((e,t)=>{let r=n[u.id]===t;return(0,Z.jsxs)(`button`,{type:`button`,className:`option ${r?`selected`:``}`,"aria-pressed":r?`true`:`false`,onPointerMove:e=>{let t=e.currentTarget,n=t.getBoundingClientRect();t.style.setProperty(`--mx`,`${(e.clientX-n.left)/n.width*100}%`),t.style.setProperty(`--my`,`${(e.clientY-n.top)/n.height*100}%`)},onClick:()=>f(t),children:[(0,Z.jsx)(`span`,{className:`opt-radio`,"aria-hidden":`true`}),(0,Z.jsx)(`span`,{className:`opt-emoji`,"aria-hidden":`true`,children:e.emoji}),(0,Z.jsxs)(`span`,{children:[(0,Z.jsx)(`span`,{className:`opt-label`,children:e.label}),e.sub?(0,Z.jsx)(`span`,{className:`opt-sub`,children:e.sub}):null]})]},t)})}),(0,Z.jsxs)(`div`,{className:`nav`,children:[e>0?(0,Z.jsx)(`button`,{type:`button`,className:`btn btn-ghost`,onClick:m,children:`← Назад`}):(0,Z.jsx)(`div`,{}),(0,Z.jsx)(`button`,{type:`button`,className:`btn btn-primary`,disabled:!x,onClick:()=>{e===ll.length-1?h():t(e=>e+1)},children:e===ll.length-1?`Завершить ✓`:`Далее →`})]})]})]}),(0,Z.jsx)(`p`,{className:`footer-note`,children:`Сайт работает на GitHub Pages, ответы уходят в Formspree. На телефоне фон облегчён автоматически.`})]})]})]})}(0,te.createRoot)(document.getElementById(`root`)).render((0,Z.jsx)(_.StrictMode,{children:(0,Z.jsx)(fl,{})}));