...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Wa(e,t,n){let r=new Float32Array(Aa),i=new U(0,1,0);return new wi({name:`SphericalGaussianBlur`,defines:{n:Aa,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:qa(),fragmentShader:`
...
`,Lc=8;function Rc(e){let t=e.trim();t.startsWith(`#`)&&(t=t.slice(1));let n=255,r=255,i=255;return t.length===3?(n=parseInt(t[0]+t[0],16),r=parseInt(t[1]+t[1],16),i=parseInt(t[2]+t[2],16)):t.length===6&&(n=parseInt(t.slice(0,2),16),r=parseInt(t.slice(2,4),16),i=parseInt(t.slice(4,6),16)),new U(n/255,r/255,i/255)}function zc({linesGradient:e,enabledWaves:t=[`top`,`middle`,`bottom`],lineCount:n=[6],lineDistance:r=[5],topWavePosition:i,middleWavePosition:a,bottomWavePosition:o={x:2,y:-.7,rotate:-1},animationSpeed:s=1,interactive:c=!0,bendRadius:l=5,bendStrength:u=-.5,mouseDamping:d=.05,parallax:f=!0,parallaxStrength:p=.2,mixBlendMode:m=`screen`,className:h}){let g=(0,_.useRef)(null),v=(0,_.useRef)(new Ot(-1e3,-1e3)),y=(0,_.useRef)(new Ot(-1e3,-1e3)),b=(0,_.useRef)(0),x=(0,_.useRef)(0),S=(0,_.useRef)(new Ot(0,0)),C=(0,_.useRef)(new Ot(0,0)),w=Nc(),T=c&&!w,E=f&&!w,D=e=>typeof n==`number`?n:t.includes(e)?n[t.indexOf(e)]??6:0,O=e=>typeof r==`number`?r:t.includes(e)?r[t.indexOf(e)]??.1:.1,ee=t.includes(`top`)?D(`top`):0,k=t.includes(`middle`)?D(`middle`):0,A=t.includes(`bottom`)?D(`bottom`):0,te=t.includes(`top`)?O(`top`)*.01:.01,ne=t.includes(`middle`)?O(`middle`)*.01:.01,j=t.includes(`bottom`)?O(`bottom`)*.01:.01;return(0,_.useEffect)(()=>{let n=g.current;if(!n)return;let r=!0,c=new Fn,f=new Zi(-1,1,1,-1,0,1);f.position.z=1;let m=new Mc({antialias:!0,alpha:!0}),h=w?1.25:2;m.setPixelRatio(Math.min(window.devicePixelRatio||1,h)),m.domElement.style.width=`100%`,m.domElement.style.height=`100%`,n.appendChild(m.domElement);let _={iTime:{value:0},iResolution:{value:new U(1,1,1)},animationSpeed:{value:s},enableTop:{value:t.includes(`top`)},enableMiddle:{value:t.includes(`middle`)},enableBottom:{value:t.includes(`bottom`)},topLineCount:{value:ee},middleLineCount:{value:k},bottomLineCount:{value:A},topLineDistance:{value:te},middleLineDistance:{value:ne},bottomLineDistance:{value:j},topWavePosition:{value:new U(i?.x??10,i?.y??.5,i?.rotate??-.4)},middleWavePosition:{value:new U(a?.x??5,a?.y??0,a?.rotate??.2)},bottomWavePosition:{value:new U(o?.x??2,o?.y??-.7,o?.rotate??.4)},iMouse:{value:new Ot(-1e3,-1e3)},interactive:{value:T},bendRadius:{value:l},bendStrength:{value:u},bendInfluence:{value:0},parallax:{value:E},parallaxStrength:{value:p},parallaxOffset:{value:new Ot(0,0)},lineGradient:{value:Array.from({length:Lc},()=>new U(1,1,1))},lineGradientCount:{value:0}};if(e&&e.length>0){let t=e.slice(0,Lc);_.lineGradientCount.value=t.length,t.forEach((e,t)=>{let n=Rc(e);_.lineGradient.value[t].set(n.x,n.y,n.z)})}let D=new wi({uniforms:_,vertexShader:Fc,fragmentShader:Ic,transparent:!0,depthWrite:!1}),O=new hi(2,2),re=new Qr(O,D);c.add(re);let M=new ma,N=()=>{if(!r)return;let e=n.clientWidth||1,t=n.clientHeight||1;m.setSize(e,t,!1);let i=m.domElement.width,a=m.domElement.height;_.iResolution.value.set(i,a,1)};N();let ie=typeof ResizeObserver<`u`?new ResizeObserver(()=>{r&&N()}):null;ie&&ie.observe(n);let ae=e=>{let t=m.domElement.getBoundingClientRect(),n=e.clientX-t.left,r=e.clientY-t.top,i=m.getPixelRatio();if(v.current.set(n*i,(t.height-r)*i),b.current=1,E){let e=t.width/2,i=t.height/2,a=(n-e)/t.width,o=-(r-i)/t.height;S.current.set(a*p,o*p)}},oe=()=>{b.current=0};T&&(m.domElement.addEventListener(`pointermove`,ae),m.domElement.addEventListener(`pointerleave`,oe));let P=0,se=()=>{r&&(_.iTime.value=M.getElapsedTime(),T&&(y.current.lerp(v.current,d),_.iMouse.value.copy(y.current),x.current+=(b.current-x.current)*d,_.bendInfluence.value=x.current),E&&(C.current.lerp(S.current,d),_.parallaxOffset.value.copy(C.current)),m.render(c,f),P=requestAnimationFrame(se))};return se(),()=>{r=!1,cancelAnimationFrame(P),ie&&ie.disconnect(),T&&(m.domElement.removeEventListener(`pointermove`,ae),m.domElement.removeEventListener(`pointerleave`,oe)),O.dispose(),D.dispose(),m.dispose(),m.forceContextLoss(),m.domElement.parentElement&&m.domElement.parentElement.removeChild(m.domElement)}},[e,t,n,r,i,a,o,s,T,l,u,d,E,p,w]),(0,X.jsx)(`div`,{ref:g,className:`floating-lines-container ${h||``}`,style:{mixBlendMode:m},"aria-hidden":`true`})}var Bc=`https://formspree.io/f/xzdyajgz`,Vc=[`Регион`,`Идея`,`Цифра`,`Цена`],Hc=[{id:`region`,type:`text`,number:`01`,text:`Из какого вы города или района?`,sub:`Название поможет понять географию спроса — можно кратко.`,placeholder:`Например: Самарканд, Наманган, Андижан…`},{id:`idea`,type:`single`,number:`02`,text:`Какая IT-идея, на ваш взгляд, нужнее всего в регионах Узбекистана?`,sub:`Сначала пролистайте все идеи, затем выберите одну.`,options:[{emoji:`🔧`,label:`Маркетплейс мастеров и ремонта`,sub:`Найти сантехника, электрика, отделочника`,details:[`Каталог мастеров по району`,`Отзывы и фото работ`,`Заявка и быстрый отклик`,`Прозрачные цены`]},{emoji:`👷`,label:`HR-платформа для рабочих`,sub:`Заводы, стройки, рестораны ищут сотрудников`,details:[`Вакансии рядом с домом`,`Быстрый отклик без резюме`,`Смены/подработки`,`Рейтинг работодателей`]},{emoji:`📊`,label:`SaaS-учёт для малого бизнеса`,sub:`Бухгалтерия и касса для ИП и магазинов`,details:[`Продажи и остатки`,`Долги/поставщики`,`Отчёты одним кликом`,`Работа с телефона`]},{emoji:`🌾`,label:`Агромаркетплейс для фермеров`,sub:`Продажа урожая напрямую без посредников`,details:[`Покупатели из городов`,`Цены по регионам`,`Опт и розница`,`Доставка/логистика партнёров`]},{emoji:`📦`,label:`Логистика и доставка`,sub:`Для интернет-магазинов и e-commerce`,details:[`Курьеры по городу`,`Трекинг заказов`,`Оплата при получении`,`Интеграция с магазинами`]},{emoji:`🎓`,label:`EdTech — подготовка к DTM/ЕГЭ`,sub:`Онлайн-репетиторы и курсы`,details:[`Тесты и разборы`,`Личный план подготовки`,`Учителя по предметам`,`Занятия вечером/в выходные`]}]},{id:`digital`,type:`single`,number:`03`,text:`Люди 25+ лет у вас дома — насколько уверенно пользуются смартфоном и интернетом?`,sub:`Ориентируйтесь на родителей, соседей, знакомых из вашего города или района.`,options:[{emoji:`💪`,label:`Уверенно — сами всё делают`,sub:`Оплачивают, заказывают такси, переписываются`},{emoji:`🙂`,label:`В основном справляются`,sub:`Иногда просят детей помочь с чем-то новым`},{emoji:`😕`,label:`Только базовое`,sub:`WhatsApp и звонки — больше ничего`},{emoji:`📵`,label:`Почти не пользуются`,sub:`Кнопочный телефон или вообще без смартфона`}]},{id:`price`,type:`single`,number:`04`,text:`Какую сумму в месяц люди у вас готовы платить за удобный сервис?`,sub:`Например, за приложение, где легко найти мастера или работника.`,options:[{emoji:`🆓`,label:`Только бесплатно`,sub:`Платить за приложение не будут вообще`},{emoji:`💵`,label:`10 000 – 20 000 сум (~$0.8–1.5)`,sub:`Небольшая сумма, почти символическая`},{emoji:`💰`,label:`30 000 – 50 000 сум (~$2.5–4)`,sub:`Если сервис реально полезный`},{emoji:`💎`,label:`100 000+ сум (~$8+)`,sub:`За качественный продукт заплатят хорошо`}]}];async function Uc(e){let t=typeof Bc==`string`&&Bc.trim()||``;if(!t)return{ok:!1,skipped:!0};let n=await fetch(t,{method:`POST`,headers:{"Content-Type":`application/json`,Accept:`application/json`},body:JSON.stringify({_subject:`Опрос IT Узбекистан — новый ответ`,...e})});return{ok:n.ok,skipped:!1,status:n.status}}function Wc(e){return Math.max(0,Math.min(100,e))}function Gc(){let[e,t]=(0,_.useState)(0),[n,r]=(0,_.useState)({region:``,idea:null,digital:null,price:null}),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)({state:`idle`}),c=Math.round((Math.min(e,Hc.length-1)+1)/Hc.length*100),l=Hc[e],u=t=>t<e?`done`:t===e?`active`:`todo`,d=e=>{r(t=>({...t,[l.id]:e}))},f=()=>{let e=(n.region||``).trim();r(t=>({...t,region:e||`Не указано`})),t(e=>Math.min(e+1,Hc.length-1))},p=()=>t(e=>Math.max(0,e-1)),m=async()=>{a(!0),s({state:`sending`});let e=n.idea,t=n.digital,r=n.price,i=Hc[1].options?.[e]?.label||`—`,o=Hc[2].options?.[t]?.label||`—`,c=Hc[3].options?.[r]?.label||`—`,l={region:n.region||`Не указано`,idea:i,idea_index:e,digital:o,digital_index:t,price:c,price_index:r,submitted_at:new Date().toISOString()};try{let e=await Uc(l);e.ok?s({state:`ok`}):s({state:`err`,status:e.status})}catch{s({state:`err`})}},h=()=>{r({region:``,idea:null,digital:null,price:null}),t(0),a(!1),s({state:`idle`})},g=(0,_.useMemo)(()=>{let e=Hc[1].options?.[n.idea]?.label||`—`,t=Hc[2].options?.[n.digital]?.label||`—`,r=Hc[3].options?.[n.price]?.label||`—`;return`📍 Регион: ${n.region||`Не указано`}\n💡 Лучшая идея: ${e}\n📱 Уровень цифровой грамотности 25+: ${t}\n💳 Готовность платить: ${r}`},[n]),v=Wc([90,65,35,10][n.digital??1]??50),y=Wc([5,40,75,100][n.price??1]??50),b=l?.type===`text`?!0:n[l.id]!==null&&n[l.id]!==void 0;return(0,X.jsxs)(X.Fragment,{children:[(0,X.jsx)(`div`,{className:`bg-webgl`,children:(0,X.jsx)(zc,{enabledWaves:[`top`,`middle`,`bottom`],lineCount:[5,7,5],lineDistance:[8,8,8],bendRadius:8,bendStrength:-2,interactive:!0,parallax:!0,animationSpeed:1,linesGradient:[`#e945f5`,`#a78bfa`,`#6a6a6a`],mixBlendMode:`screen`})}),(0,X.jsxs)(`div`,{className:`wrap`,children:[(0,X.jsxs)(`header`,{className:`hero`,role:`banner`,children:[(0,X.jsxs)(`div`,{className:`badge`,children:[(0,X.jsx)(`span`,{className:`badge-dot`,"aria-hidden":`true`}),` IT-опрос · Узбекистан`]}),(0,X.jsx)(`h1`,{children:`Какие IT-идеи реально нужны в вашем регионе?`}),(0,X.jsxs)(`div`,{className:`hero-meta`,children:[(0,X.jsx)(`span`,{children:`Анонимно`}),(0,X.jsx)(`span`,{children:`~3 минуты`}),(0,X.jsx)(`span`,{children:`С телефона удобно`})]})]}),(0,X.jsx)(`div`,{className:`stepper`,"aria-hidden":`true`,children:Hc.map((e,t)=>{let n=u(t);return(0,X.jsxs)(`div`,{className:`step ${n}`,children:[(0,X.jsx)(`div`,{className:`step-circle`,children:n===`done`?`✓`:t+1}),(0,X.jsx)(`span`,{className:`step-label`,children:Vc[t]})]},t)})}),(0,X.jsxs)(`div`,{className:`progress-wrap`,"aria-hidden":`true`,children:[(0,X.jsxs)(`div`,{className:`progress-meta`,children:[(0,X.jsx)(`span`,{children:i?`Готово`:`Вопрос ${e+1} из ${Hc.length}`}),(0,X.jsx)(`span`,{children:i?`100%`:`${c}%`})]}),(0,X.jsx)(`div`,{className:`progress-bar-bg`,children:(0,X.jsx)(`div`,{className:`progress-bar-fill`,style:{width:`${i?100:c}%`}})})]}),(0,X.jsxs)(`main`,{role:`main`,children:[i?(0,X.jsxs)(`div`,{className:`results-card`,children:[o.state===`sending`?(0,X.jsx)(`div`,{className:`submission-banner warn`,children:`Отправка ответов…`}):o.state===`ok`?(0,X.jsx)(`div`,{className:`submission-banner ok`,children:`Ответы отправлены. Спасибо!`}):o.state===`err`?(0,X.jsxs)(`div`,{className:`submission-banner err`,children:[`Не удалось отправить ответы`,o.status?` (код ${o.status})`:``,`. Итог ниже можно скопировать вручную.`]}):null,(0,X.jsxs)(`div`,{className:`results-header`,children:[(0,X.jsx)(`div`,{className:`results-icon`,"aria-hidden":`true`,children:`✅`}),(0,X.jsx)(`h2`,{children:`Спасибо за ответы`}),(0,X.jsx)(`p`,{children:`Ниже — краткий итог. Полные ответы доступны в кабинете Formspree.`})]}),(0,X.jsxs)(`div`,{className:`result-row`,children:[(0,X.jsx)(`div`,{className:`result-label`,children:`📍 Ваш регион`}),(0,X.jsx)(`div`,{className:`result-value`,children:n.region||`Не указано`})]}),(0,X.jsx)(`div`,{className:`divider`}),(0,X.jsxs)(`div`,{className:`result-row`,children:[(0,X.jsx)(`div`,{className:`result-label`,children:`💡 Самая нужная идея`}),(0,X.jsxs)(`div`,{className:`result-value`,children:[Hc[1].options?.[n.idea]?.emoji,` `,Hc[1].options?.[n.idea]?.label]})]}),(0,X.jsx)(`div`,{className:`divider`}),(0,X.jsxs)(`div`,{className:`result-row`,children:[(0,X.jsx)(`div`,{className:`result-label`,children:`📱 Цифровая грамотность 25+`}),(0,X.jsxs)(`div`,{className:`result-value`,children:[Hc[2].options?.[n.digital]?.emoji,` `,Hc[2].options?.[n.digital]?.label]}),(0,X.jsx)(`div`,{className:`result-bar-bg`,children:(0,X.jsx)(`div`,{className:`result-bar-fill`,style:{width:`${v}%`}})})]}),(0,X.jsx)(`div`,{className:`divider`}),(0,X.jsxs)(`div`,{className:`result-row`,children:[(0,X.jsx)(`div`,{className:`result-label`,children:`💳 Готовность платить`}),(0,X.jsxs)(`div`,{className:`result-value`,children:[Hc[3].options?.[n.price]?.emoji,` `,Hc[3].options?.[n.price]?.label]}),(0,X.jsx)(`div`,{className:`result-bar-bg`,children:(0,X.jsx)(`div`,{className:`result-bar-fill`,style:{width:`${y}%`}})})]}),(0,X.jsxs)(`div`,{className:`copy-block`,children:[(0,X.jsx)(`div`,{className:`copy-label`,children:`Скопируйте итог`}),(0,X.jsx)(`pre`,{className:`copy-text`,id:`copy-content`,children:g}),(0,X.jsx)(`button`,{type:`button`,className:`copy-btn`,onClick:async e=>{let t=e.currentTarget;try{await navigator.clipboard.writeText(g),t.textContent=`✅ Скопировано`,window.setTimeout(()=>t.textContent=`📋 Скопировать ответы`,1800)}catch{t.textContent=`Не удалось скопировать`,window.setTimeout(()=>t.textContent=`📋 Скопировать ответы`,1800)}},children:`📋 Скопировать ответы`})]}),(0,X.jsx)(`button`,{type:`button`,className:`btn btn-ghost full`,onClick:h,children:`Пройти заново`})]}):(0,X.jsxs)(`div`,{className:`question-card`,children:[(0,X.jsxs)(`div`,{className:`q-number`,children:[`Вопрос `,l.number]}),(0,X.jsx)(`h2`,{className:`q-text`,children:l.text}),(0,X.jsx)(`p`,{className:`q-sub`,children:l.sub}),l.type===`text`?(0,X.jsxs)(X.Fragment,{children:[(0,X.jsx)(`label`,{className:`sr-only`,htmlFor:`region`,children:l.text}),(0,X.jsx)(`input`,{id:`region`,className:`region-input`,type:`text`,inputMode:`text`,autoComplete:`address-level2`,placeholder:l.placeholder,value:n.region,onChange:e=>r(t=>({...t,region:e.target.value})),onKeyDown:e=>{e.key===`Enter`&&f()}}),(0,X.jsxs)(`div`,{className:`nav`,children:[(0,X.jsx)(`div`,{}),(0,X.jsx)(`button`,{type:`button`,className:`btn btn-primary`,onClick:f,children:`Далее →`})]})]}):(0,X.jsxs)(X.Fragment,{children:[l.id===`idea`?(0,X.jsx)(Kc,{question:l,selectedIndex:n.idea,onSelect:d}):(0,X.jsx)(`div`,{className:`options`,role:`radiogroup`,"aria-label":l.text,children:l.options.map((e,t)=>{let r=n[l.id]===t;return(0,X.jsxs)(`button`,{type:`button`,className:`option ${r?`selected`:``}`,"aria-pressed":r?`true`:`false`,onPointerMove:e=>{let t=e.currentTarget,n=t.getBoundingClientRect();t.style.setProperty(`--mx`,`${(e.clientX-n.left)/n.width*100}%`),t.style.setProperty(`--my`,`${(e.clientY-n.top)/n.height*100}%`)},onClick:()=>d(t),children:[(0,X.jsx)(`span`,{className:`opt-radio`,"aria-hidden":`true`}),(0,X.jsx)(`span`,{className:`opt-emoji`,"aria-hidden":`true`,children:e.emoji}),(0,X.jsxs)(`span`,{children:[(0,X.jsx)(`span`,{className:`opt-label`,children:e.label}),e.sub?(0,X.jsx)(`span`,{className:`opt-sub`,children:e.sub}):null]})]},t)})}),(0,X.jsxs)(`div`,{className:`nav`,children:[e>0?(0,X.jsx)(`button`,{type:`button`,className:`btn btn-ghost`,onClick:p,children:`← Назад`}):(0,X.jsx)(`div`,{}),(0,X.jsx)(`button`,{type:`button`,className:`btn btn-primary`,disabled:!b,onClick:()=>{b&&(e===Hc.length-1?m():t(e=>e+1))},children:e===Hc.length-1?`Завершить ✓`:`Далее →`})]})]})]}),(0,X.jsx)(`p`,{className:`footer-note`,children:`Сайт работает на GitHub Pages, ответы уходят в Formspree. На телефоне фон облегчён автоматически.`})]})]})]})}function Kc({question:e,selectedIndex:t,onSelect:n}){let r=(0,_.useRef)(null),[i,a]=(0,_.useState)(0);(0,_.useEffect)(()=>{let t=r.current;if(!t)return;let n=()=>{let n=t.clientWidth||1,r=Math.round(t.scrollLeft/n);a(Math.max(0,Math.min(e.options.length-1,r)))};return t.addEventListener(`scroll`,n,{passive:!0}),n(),()=>t.removeEventListener(`scroll`,n)},[e.options.length]);let o=e=>{let t=r.current;t&&t.scrollTo({left:e*t.clientWidth,behavior:`smooth`})};return(0,X.jsxs)(`div`,{className:`idea-wrap`,role:`radiogroup`,"aria-label":e.text,children:[(0,X.jsxs)(`div`,{className:`idea-top`,children:[(0,X.jsx)(`div`,{className:`idea-hint`,children:`Листайте идеи → затем выберите одну`}),(0,X.jsxs)(`div`,{className:`idea-nav`,children:[(0,X.jsx)(`button`,{type:`button`,className:`idea-arrow`,onClick:()=>o(Math.max(0,i-1)),"aria-label":`Предыдущая идея`,children:`←`}),(0,X.jsx)(`button`,{type:`button`,className:`idea-arrow`,onClick:()=>o(Math.min(e.options.length-1,i+1)),"aria-label":`Следующая идея`,children:`→`})]})]}),(0,X.jsx)(`div`,{className:`idea-scroller`,ref:r,children:e.options.map((e,r)=>{let i=t===r;return(0,X.jsx)(`div`,{className:`idea-slide`,children:(0,X.jsxs)(`div`,{className:`idea-card ${i?`selected`:``}`,children:[(0,X.jsxs)(`div`,{className:`idea-head`,children:[(0,X.jsx)(`div`,{className:`idea-emoji`,"aria-hidden":`true`,children:e.emoji}),(0,X.jsxs)(`div`,{children:[(0,X.jsx)(`div`,{className:`idea-title`,children:e.label}),e.sub?(0,X.jsx)(`div`,{className:`idea-sub`,children:e.sub}):null]})]}),Array.isArray(e.details)&&e.details.length>0?(0,X.jsx)(`ul`,{className:`idea-details`,children:e.details.map((e,t)=>(0,X.jsx)(`li`,{children:e},t))}):null,(0,X.jsx)(`button`,{type:`button`,className:`idea-pick ${i?`picked`:``}`,"aria-pressed":i?`true`:`false`,onClick:()=>n(r),children:i?`Выбрано ✓`:`Выбрать эту идею`})]})},r)})}),(0,X.jsx)(`div`,{className:`idea-dots`,"aria-hidden":`true`,children:e.options.map((e,t)=>(0,X.jsx)(`button`,{type:`button`,className:`idea-dot ${t===i?`active`:``}`,onClick:()=>o(t),"aria-label":`Идея ${t+1}`},t))})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,X.jsx)(_.StrictMode,{children:(0,X.jsx)(Gc,{})}));