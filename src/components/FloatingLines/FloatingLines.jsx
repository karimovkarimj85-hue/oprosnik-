...
import { isCoarsePointer } from '../../lib/device.js';
...
export default function FloatingLines({
  ...
  // Mobile friendliness: no pointer bending + lower DPR for performance
  const coarse = isCoarsePointer();
  const interactive = interactiveProp && !coarse;
  const parallax = parallaxProp && !coarse;
  ...
  useEffect(() => {
    ...
    // Cap DPR: phones can be expensive
